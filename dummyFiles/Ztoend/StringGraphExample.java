...
class Graph {
    ...
    public void addEdge(String source, String destination) {
        ...
        adjacencyList.get(destination).add(source); // Uncomment if the graph is undirected
    }
...
public class StringGraphExample {
    public static void main(String[] args) {
        ...
        String source = "Shaheed Sthal (New Bus Adda)";
        String destination = "Rithala";
        List<String> shortestPath = graph.shortestPathBFS(source, destination);
